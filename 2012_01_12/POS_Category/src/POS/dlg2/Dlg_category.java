...
//        tbl_cat.setAutoResizeMode(0);
        int[] tbl_widths_accounts = {400, 0, 0, 100};
...
//          TableWidthUtilities.
    ...
    public static class TblInvoicesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "DESCRIPTION", "num", "img path", "open item"
        };
...
//        String name = tf_searc.getText();
    ...
    private void update_open_item() {
        ...
        final S1_categories.to_name_cat to = (S1_categories.to_name_cat) tbl_employee_payroll_ALM.get(tbl_cat.convertRowIndexToModel(idx));
