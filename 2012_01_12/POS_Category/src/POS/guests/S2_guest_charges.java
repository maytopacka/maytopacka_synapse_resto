...
//                            System.out.println(DateType.sf.format(a) + " - " + t.guest_name + " + " + 1);
                            ...
                            String s3 = "select "
                                    ...
                                    + " guest_id = '" + t.guest_id + "' "
                                    + " and Date(date_added) ='" + DateType.sf.
                                    format(a) + "' and status='" + "0" + "' "
                                    + " ";
                            ...
                            if (exists == false) {
                                S2_guest_charges.to_guest_charges to_guest_charges = new S2_guest_charges.to_guest_charges(
                                        0, t.guest_id, t.guest_name, DateType.datetime.
                                        format(a), my_rate, 0);
                                ...
                                s2 = SqlStringUtil.parse(s2).
                                        ...
                                        setString("guest_name", to_guest_charges.guest_name).
                                        setString("date_added", to_guest_charges.date_added).
                                        setString("amount", NumberFormat.df.
                                        format(my_rate)).
                                        setNumber("status", to_guest_charges.status).
...
//        JOptionPane.showMessageDialog(null, table_no);
    ...
    public static void clear_room_wo_orders(String table_id) {
        try {
            Connection conn = MyConnection.connect();
     ...
     public static void clear_room_wo_orders_top(String table_id) {
        try {
            Connection conn = MyConnection.connect();
            String s0 = "delete from " + MyDB.getNames() + ".room_guests where "
                    + " rooom_id ='" + table_id + "' "
      ...
      public static void clear_room_wo_orders_front(String table_id) {
        try {
            Connection conn = MyConnection.connect();
            String s0 = "delete from " + MyDB.getNames() + ".room_guests where "
                    + " rooom_id ='" + table_id + "' "
    ...
    public static void clear_room_w_orders(String table_id) {
        try {
            Connection conn = MyConnection.connect();
            String s0 = "delete from " + MyDB.getNames() + ".room_guests where "
                    + " rooom_id ='" + table_id + "' "
