...
public class S2_search {
    ...
    public static List<to_items> ret_items(String cat_id, String name,String is_active) {
        ...
        try {
            ...
            String s0 = "select "
                        ...
                        + "where "
                        + "description like '%" + name + "%' and cat_id = '" + cat_id + "' and is_active like '%"+is_active+"%' or "
                        + "lookup_code like '%" + name + "%' and cat_id = '" + cat_id + "' and is_active like '%"+is_active+"%' or "
                        + "product_name like '" + name + "%' and cat_id = '" + cat_id + "' and is_active like '%"+is_active+"%' order by description asc";
            ...
            while (rs.next()) {
                ...
                to_items to = new to_items(names, "pcs", desc, price, qty, img_path, qty, "-1", cat_ids, cat_name, printing_assembly, status, "", 0, 0, "", "", "", "");
                datas.add(to);
            }
            return datas;
        } catch (Exception e) {
    ...
    public static List<to_items> ret_items_no_category(String cat_id, String name,String is_active) {
        ...
        try {
            ...
            String s0 = "select "
                        ...
                        + "product_name like '" + name + "%' and cat_id like '%"+cat_id+"%'  and is_active like '%"+is_active+"%' order by description asc";
    ...
    public static List<to_items> ret_items_room(String room_no) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                to_items to = new to_items(names, "pcs", desc, price, qty, img_path, qty, guest_id, cat_id, cat_name, printing_assembly, status, disc_name, disc_rate, discount, customer_name, customer_id, customer_address, date_added);
                datas.add(to);
            }
            return datas;
        } catch (Exception e) {
...
//        JOptionPane.showMessageDialog(null, room_no);
        ...
        try {
            ...
            String s0 = "select "
                        + "count(id)"
                        + "from " + MyDB.getNames() + ".guest_charges "
                        + " " + where + " group by Date(date_added) asc";
            Statement stmt = conn.createStatement();
            ResultSet rs = stmt.executeQuery(s0);
            if (rs.next()) {
                charge = rs.getInt(1);
