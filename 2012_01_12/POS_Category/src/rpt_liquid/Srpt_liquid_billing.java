...
public class Srpt_liquid_billing {
    ...
    public Srpt_liquid_billing(String busi_name, double room_rate, String accomodation, String SUBREPORT_DIR, List<Srpt_bar_and_resto.field> rpt_bar_and_resto, List<Srpt_others.field> rpt_others, String my_date, String guest_id, String table_no, String check_in, String transfers, String accomodation_1, double accom_total, String img_path, double to_pay, String guest_name, double dollar) {
...
//         String SUBREPORT_DIR = "C:\\Users\\i1\\Dropbox\\ronald_prototypes\\report_no_db\\src\\rpt_liquid\\";
        ...
        for (int i = 0; i < 3; i++) {
            Srpt_bar_and_resto.field tbar = new Srpt_bar_and_resto.field("desc" + i, new Date(), i + 100);
        ...
        Srpt_liquid_billing rpt = new Srpt_liquid_billing(busi_name, room_rate, accomodation, SUBREPORT_DIR, rpt_bar_and_resto, rpt_others, my_date, guest_id, table_no, check_in, transfers, accomodation_1, accom_total, img_path, to_pay, guest_name, dollar);
