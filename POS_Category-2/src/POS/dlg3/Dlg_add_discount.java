...
//        tbl_discount.setAutoResizeMode(0);
...
//          TableWidthUtilities.
        ...
        tbl_discount.getTableHeader().setFont(new java.awt.Font("Arial", Font.BOLD, 12));
...
//        nd.do_pass("Enter Name","");
    ...
    private void edit_discount() {
        ...
        String name = tbl_discount.getModel().getValueAt(row, 0).toString();
        String rate = tbl_discount.getModel().getValueAt(row, 1).toString();
        final String num = tbl_discount.getModel().getValueAt(row, 3).toString();
        Window p = (Window) this;
        Dlg_prompt_discount nd = Dlg_prompt_discount.create(p, true);
    ...
    private void delete_discount() {
        ...
        String name = tbl_discount.getModel().getValueAt(row, 0).toString();
        String rate = tbl_discount.getModel().getValueAt(row, 1).toString();
        String num = tbl_discount.getModel().getValueAt(row, 3).toString();
