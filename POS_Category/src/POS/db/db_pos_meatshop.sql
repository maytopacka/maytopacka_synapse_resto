...
create table "+MyDB.getNames()+".assembly(
  id int primary key auto_increment
 ,prod_num int
 ,description varchar(100)
 ,price double
...
create table db_pos_restaurant.tables(
    ...
    ,percentage double
    ,status int
    ,table_location_id int
);

drop table if exists db_pos_casablanca.tables2;
create table db_pos_casablanca.tables2(
    id int auto_increment primary key
    ,table_name varchar(100)
    ,rate double
    ,rate_type varchar(100)
...
drop table if exists db_pos_restaurant.table_types; 
create table db_pos_restaurant.table_types( 
id int auto_increment primary key
...
drop table if exists db_pos_restaurant.customer_tables_details2;
create table db_pos_restaurant.customer_tables_details2(
  id int auto_increment primary key
 ,table_no_id varchar(100)
 ,or_no varchar(100)
 ,qty double
...
drop table if exists "+MyDB.getNames()+".customer_table_details_assembly;
create table "+MyDB.getNames()+".customer_table_details_assembly(
  id int primary key auto_increment
 ,ctd_id int
...
drop table if exists db_pos_restaurant.customer_table_details_assembly2;
create table db_pos_restaurant.customer_table_details_assembly2(
  id int primary key auto_increment
 ,ctd_id int
 ,prod_num varchar(100)
 ,description varchar(100)
...
drop table if exists "+MyDB.getNames()+".pending_order_detail_assembly;
create table "+MyDB.getNames()+".pending_order_detail_assembly(
     id int primary key auto_increment
    ,pod_id int
    ,prod_num varchar(100)
    ,description varchar(100)
...
drop table if exists "+MyDB.getNames()+".rates;
create table "+MyDB.getNames()+".rates(
    id int auto_increment primary key
    ,rate_name varchar(100)
    ,rate double
);
insert into "+MyDB.getNames()+".rates(rate_name,rate)values('PATRONAGE',2.5);
...
drop table if exists db_pos_restaurant.room_guests;
create table db_pos_restaurant.room_guests(
    id int auto_increment primary key
    ,rooom_id int
    ,guest_id varchar(100)
...
drop table if exists db_pos_restaurant.room_guests2;
create table db_pos_restaurant.room_guests2(
    id int auto_increment primary key
    ,rooom_id int
    ,guest_id varchar(100)
    ,guest_name varchar(200)
...
drop table if exists db_pos_restaurant.guest_charges2; 
create table db_pos_restaurant.guest_charges2( 
id int auto_increment primary key
,guest_id varchar(100) 
,guest_name varchar(100) 
,date_added datetime 
...
drop table if exists "+MyDB.getNames()+".countries;
create table "+MyDB.getNames()+".countries(
    id int auto_increment primary key
    ,country varchar(200)
    ,capital varchar(100)
);

drop table if exists db_pos_restaurant.remitances; 
create table db_pos_restaurant.remitances( 
id int auto_increment primary key
,user_id varchar(100) 
,user_name varchar(100) 
,user_lvl varchar(100) 
,amount double 
,date_added double 
);

drop table if exists db_pos_restaurant.guest_advance_payment; 
create table db_pos_restaurant.guest_advance_payment( 
id int auto_increment primary key
,room_id varchar(100) 
,guest_name varchar(100) 
,guest_id varchar(100) 
...
drop table if exists db_pos_restaurant.guest_advance_payment2; 
create table db_pos_restaurant.guest_advance_payment2( 
id int auto_increment primary key
,room_id varchar(100) 
,guest_name varchar(100) 
,guest_id varchar(100) 
...
drop table if exists db_pos_casablanca.customer_discounts; 
create table db_pos_casablanca.customer_discounts( 
id int auto_increment primary key
,customer_name varchar(500) 
,card_no varchar(100) 
,address varchar(500) 
);
insert into db_pos_casablanca.customer_discounts(customer_name,card_no,address)values('','','');

drop table if exists db_pos_restaurant.expenses; 
create table db_pos_restaurant.expenses( 
id int auto_increment primary key
,date_added datetime 
,user_name varchar(100) 
,amount varchar(100) 
...
drop table if exists db_pos_restaurant.table_locations; 
create table db_pos_restaurant.table_locations( 
id int auto_increment primary key
,location varchar(100) 
);

drop table if exists db_pos_casablanca.card_types; 
create table db_pos_casablanca.card_types( 
id int auto_increment primary key
,name varchar(100) 
,rate double 
);

drop table if exists db_pos_casablanca.bill_discounts; 
create table db_pos_casablanca.bill_discounts( 
id int auto_increment primary key
