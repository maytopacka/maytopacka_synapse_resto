...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/img2/add 16x16.png"))); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(8, 8, 8)
                        .addComponent(tf_search, javax.swing.GroupLayout.PREFERRED_SIZE, 376, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        nd.setVisible(true);
    ...
    private void add_product(String name, String description, String price, String qty, String remarks, String supp_id, String vat, String assembly, List<to_product_uom> tt, String is_linient, String w_com, double com_amount, String cat_id, double cost, String img_path) {
        ...
        S9_add_product.add(name, description, price, qty, remarks, cat, supp_id, vat, assembly, tt, is_linient, w_com, com_amount, cat_id, cost, img_path);
    }
...
//        String name = tf_searc.getText();
    ...
    private void set_category() {
        ...
        String vat = tbl_prod.getModel().getValueAt(row, 5).toString();
        type_id = tbl_prod.getModel().getValueAt(row, 6).toString();
        String id = type_id;
        String num = tbl_prod.getModel().getValueAt(row, 4).toString();
...
//       
    ...
    private void update_product() {
        ...
        String num = tbl_prod.getModel().getValueAt(row, 4).toString();
        String name = tbl_prod.getModel().getValueAt(row, 0).toString();
        String desc = tbl_prod.getModel().getValueAt(row, 1).toString();
        String price = tbl_prod.getModel().getValueAt(row, 2).toString();
        String qty = tbl_prod.getModel().getValueAt(row, 3).toString();
        String vat = tbl_prod.getModel().getValueAt(row, 5).toString();
        String category_type = tbl_prod.getModel().getValueAt(row, 6).toString();
        String is_linient = tbl_prod.getModel().getValueAt(row, 7).toString();
        String w_comm = tbl_prod.getModel().getValueAt(row, 8).toString();
        double comm_amount = Double.parseDouble(tbl_prod.getModel().getValueAt(row, 9).toString());
        double cost = Double.parseDouble(tbl_prod.getModel().getValueAt(row, 11).toString());


        String cat_id = tbl_prod.getModel().getValueAt(row, 10).toString();
        Window p = (Window) this;
...
//                closeDialog.ok();
    ...
    private void delete_product() {
        ...
        final String num = tbl_prod.getModel().getValueAt(row, 0).toString();
...
//                closeDialog.ok();
    ...
    private void add_type() {
        ...
        nd.setTitle("Prompt");
        nd.do_pass(cb_category.getSelectedItem().toString());
...
//                closeDialog.ok();
    ...
    private void print_barcode() {
        ...
        final String name = tbl_prod.getModel().getValueAt(row, 0).toString();
        final String desc = tbl_prod.getModel().getValueAt(row, 1).toString();
        final double price = Double.parseDouble(tbl_prod.getModel().getValueAt(row, 2).toString());
        final String qty = tbl_prod.getModel().getValueAt(row, 3).toString();
        final String vat = tbl_prod.getModel().getValueAt(row, 5).toString();
