...
//        }
    ...
    private void add_item() {
        ...
        S9_add_product.add(barcode, description, price, "0", "", "none", "", "0", "0", new ArrayList(), is_linient, "0", 0, category_id, 0, "", is_active, printing_assembly, group_id);
        clear_item();
        data_employee_search();
...
//        tbl_prod.setAutoResizeMode(0);
        int[] tbl_widths_accounts = {0, 300, 100, 100, 0, 0, 0, 100, 0, 0, 0, 0, 0, 0};
