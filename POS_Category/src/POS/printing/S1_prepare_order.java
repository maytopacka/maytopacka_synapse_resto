...
public class S1_prepare_order {
    ...
    public static class to_prepare_receipt {
        ...
        public to_prepare_receipt(String table_no, String printing_assembly, String printing_assembly_name) {
    ...
    public static void main(String[] args) {
        ...
        S1_prepare_order.to_prepare_receipt to = new S1_prepare_order.to_prepare_receipt("" + "8", "3", "asdasdasd");
        try {
            JasperReport jasperReport;
            JasperPrint jasperPrint;
            Connection conn = PoolConnection.connect();
            String l = "/POS/printing/rpt_prepare_receipt_1.jrxml";
            InputStream is = S1_prepare_order.class.getResourceAsStream(l);
    ...
    public static void prepare_food(to_prepare_receipt to) {
        try {
            ...
            if (System.getProperty("version", "resto").equals("ordering")) {
                ...
                l = "/POS/printing/rpt_prepare_casablanca_1_1.jrxml";
            }
            InputStream is = S1_prepare_order.class.getResourceAsStream(l);
            jasperReport = JasperCompileManager.compileReport(is);
            jasperPrint = JasperFillManager.fillReport(jasperReport, JasperUtil.setParameter(to), conn);
    ...
    public static void bill_table(to_print_order to) {
        try {
            ...
            if (System.getProperty("version", "resto").equals("ordering")) {
                ...
                l = "/POS/printing/rpt_print_orders_casablanca_1.jrxml";
            }
            InputStream is = S1_prepare_order.class.getResourceAsStream(l);
            jasperReport = JasperCompileManager.compileReport(is);
            jasperPrint = JasperFillManager.fillReport(jasperReport, JasperUtil.setParameter(to), conn);
