...
public class S1_my_sales {
    ...
    public static List<to_receipts> ret_data(String session_id,String date_from,String date_to) {
        ...
        try {
            ...
            String s0 = "select "
                        ...
                        + " cashier_session_id ='" + session_id + "' and Date(receipt_date) between '"+date_from+"' and '"+date_to+"'"
                        + " ";
