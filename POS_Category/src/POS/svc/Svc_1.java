...
//            JOptionPane.showMessageDialog(null, "adadad");
    ...
    public static void pay(to_pay to_pay, String name, to_disc to1, to_credit to2, int bb, String member_id, List<Dlg_check_liquid.to_guests> my_guest, String table_no, String user_id, String or_no, int table_location_id) {
        ...
        try {
            ...
            String s10 = "select max(id) from " + MyDB.getNames() + ".cashier_sessions where cashier_name = '" + name + "' and login_status = 1";
...
//                JOptionPane.showMessageDialog(null, credit);
            ...
            if (bb == 2) {
                ...
                String s0 = "insert into " + MyDB.getNames() + ".receipts(cashier_session_id,tendered,or_number,receipt_date,discount,credit,approval_code,member_id,is_payed,dollar,credit_dollar,dollar_rate)"
                            + "values(:a_cashier_session_id,:a_tendered,:a_or_number,:a_receipt_date,:a_discount,:a_credit,:a_approval_code,:a_member_id,:a_is_payed"
                            + ",:a_dollar,:a_credit_dollar,:a_dollar_rate)  ";
                s0 = SqlStringUtil.parse(s0).
...
//                double credit = 0;
                ...
                String s0 = "insert into " + MyDB.getNames() + ".receipts(cashier_session_id,tendered,or_number,receipt_date,discount,credit,approval_code,member_id,is_payed,dollar,credit_dollar,dollar_rate)"
                            + "values(:a_cashier_session_id,:a_tendered,:a_or_number,:a_receipt_date,:a_discount,:a_credit,:a_approval_code,:a_member_id,:a_is_payed,:a_dollar,:a_credit_dollar,:a_dollar_rate)  ";
                s0 = SqlStringUtil.parse(s0).
                        setNumber("a_cashier_session_id", id).
                        setNumber("a_tendered", to_pay.tendered).
                        setString("a_or_number", or_no).
...
//                p_receipt_items_add(receipt_id, too.code, too.unit_price, too.hd_uom, to_pay.or, to1.tot_disc, too.product_name);
            ...
            for (to_order too : tps) {
                ...
                if (user_id.equals("5") || (check_out == 1 && user_id.equals("6")) || user_id.equals("0")) {
    ...
    // bir
    public static void pay2(to_pay to_pay, String name, to_disc to1, to_credit to2, int bb, String member_id, List<Dlg_check_liquid.to_guests> my_guest, String table_no, String user_id, String or_no, int tbl_location_id) {
...
//                p_receipt_items_add(receipt_id, too.code, too.unit_price, too.hd_uom, to_pay.or, "0", too.product_name);
            ...
            String s3 = "update " + MyDB.getNames() + ".bill_discounts set status='" + "1" + "' where table_id='" + table_no + "' and status='"+"0"+"'";
            PreparedStatement stmt3 = conn.prepareStatement(s3);
            stmt3.execute();
