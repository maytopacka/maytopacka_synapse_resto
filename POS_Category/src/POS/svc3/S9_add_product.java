...
public class S9_add_product {
    ...
    public static List<to_add_product> ret_products(String type, String names) {
        ...
        try {
            ...
            String s0 = "select product_name,description,price,product_qty,prod_num,is_vat,types_num,is_linient,w_commission,comm_amount"
                    + ",cat_id,cost,printing_assembly,is_active  from " + MyDB.
    ...
    public static List<to_add_product> ret_products_category(String type, String names, String cat_id) {
        ...
        try {
            ...
            String s0 = "select product_name,description,price,product_qty,prod_num,is_vat,types_num,is_linient,w_commission,comm_amount,cat_id,cost,printing_assembly,is_active  from " + MyDB.
                    getNames() + ".inventory2_stocks_left"
    ...
    public static void add(String name, String description, String price, String qty, String remarks, String types, String supp_id, String vat, String assembly, List<S7_uom.to_product_uom> tt, String is_linient, String w_com, double com_amount, String cat_id, double cost, String img_path, int is_active,int printing_assembly,int group_id) {
...
//            stmt.execute();
            ...
            String s1 = "insert into " + MyDB.getNames() + ".inventory2_stocks_left(prod_num,product_name,description,price,product_qty,types,types_num,is_vat,prod_assembly,is_linient,w_commission,comm_amount,cat_id,cost,img_path,is_active,printing_assembly,group_id)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
