...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        lbl_guest.setText("Ronald Pascua, Ronasdasda, Rawed, asdasdads, sdfsdf, werwer, wertwer");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(lbl_guest, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//    }
    ...
    public void do_pass(List<Dlg_check_liquid.to_guests> guest, String table_name, String table_ids) {
...
//                btn_0.doClick();
    ...
    private void init_tbl_tables() {
        ...
        int[] tbl_widths_tables = {0, 100, 100, 100};
    ...
    private void do_transfer() {
        ...
        S1_table_transfer.edit_data(my_guest, "" + to.id, table_id);
        data_cols();
        ok1();
    }
