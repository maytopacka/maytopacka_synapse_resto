...
import rpt_liquid.S1_bill_discounts.to_bill_discounts;
...
//         System.out.println(rate);
    ...
    int j = 0;
    rpt_orders1 to1 = new rpt_orders1("", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 0);
    double to_pay = 0;
    ...
    public void do_pass(rpt_orders1 to, String jrxml_name, List<rpt_orders1.field> datas, List<S2_search.to_items> items, String table_id) {
        ...
        j = 1;
        rpt_orders1 to2 = new rpt_orders1(to.table_no, to.business_name, to.operated_by, to.address, to.telephone_number, to.traction_no, to.cashier_name, to.waiter_name, to.tin_no, to.min_no, to.serial_no, to.permit_no, to.or_no, to.trans_no, to.pos_no, to.discount);
...
//      
    ...
    private void print() {
        ...
        double dollar = to_pay / 41;
        rpt_orders1 to2 = new rpt_orders1(to1.table_no, to1.business_name, to1.operated_by, to1.address, to1.telephone_number, to1.traction_no, to1.cashier_name, to1.waiter_name, to1.tin_no, to1.min_no, to1.serial_no, to1.permit_no, to1.or_no, to1.trans_no, to1.pos_no, discount);
...
//                btn_0.doClick();
    ...
    public static JasperReport compileJasper() {
        ...
        try {
            ...
            InputStream is = rpt_liquid.Srpt_liquid_billing.class.getResourceAsStream(jrxml);
