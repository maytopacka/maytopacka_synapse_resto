...
public class Dlg_check_liquid extends javax.swing.JDialog {
    ...
    public static class OutputData {
        ...
        public OutputData(List<Dlg_check_liquid.to_guests> to1, double percentages) {
            this.to1 = to1;
...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl_plus, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 10, 40, 40));
        ...
        getContentPane().add(btn_transfer, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 170, 160, 40));

        btn_p_close1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btn_p_close1.setText("CLOSE");
        ...
        getContentPane().add(btn_p_close1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 250, 160, 40));
        ...
        getContentPane().add(btn_p_cancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 210, 160, 40));
        ...
        getContentPane().add(btn_p_check, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 10, 120, 40));
        ...
        getContentPane().add(btn_p_order, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 50, 160, 40));
        ...
        getContentPane().add(btn_bill, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 90, 160, 40));
        ...
        getContentPane().add(btn_prepaid, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 130, 160, 40));
...
//        sample();
    ...
    private void sample() {
        ...
        for (int i = 0; i < 10; i++) {
            Dlg_check_liquid.to_guests to = new Dlg_check_liquid.to_guests("" + i, "Ronald Pascua" + i, false);
            tt.add(to);
        }
    ...
    public void do_pass2(JGrid jg_orders, DefaultListModel orders_model, int selected, String room, String types, double percent, String user_id, String status, ArrayListModel tbl_table_orders_ALM, String table_names) {
...
//
        ...
        Dlg_check_liquid.to_guests to = (Dlg_check_liquid.to_guests) tbl_tables_ALM.get((row));
        if (to.status == true) {
            to.setStatus(false);
        } else {
            to.setStatus(true);
...
//                JOptionPane.showMessageDialog(null, tbl_tables_ALM.size());
                    if (tbl_tables_ALM.size() == 1) {
                        Dlg_check_liquid.to_guests to = (Dlg_check_liquid.to_guests) tbl_tables_ALM.get((0));
                        ok.add(to);
                    }
    ...
    private void order() {
        ...
        if (ok.isEmpty()) {
            if (version.equals("ordering1")) {
                ...
                if (user.equals("5") || user.equals("0")) {
...
//                    JOptionPane.showMessageDialog(null, "6");
                    ...
                    S1_check_in.check_in(to, data.to1, t.room_rate, 1);
                }
...
//                System.out.println(a.id);
        ...
        nd.setTitle("");
        nd.do_pass(ok, table_name, room_no);
    ...
    private void ok_transfer(List<Dlg_check_liquid.to_guests> ok) {
        if (callback != null) {
            this.dispose();
            callback.transfer(new CloseDialog(this), new OutputData(ok, percentag));
        }
    }
    ...
    private void bill() {
        ...
        for (Dlg_check_liquid.to_guests a : datas) {
//            System.out.println(a.status);
            if (a.status == true && version.equals("resto") || a.status == true && version.equals("ordering")) {
                Dlg_check_liquid.to_guests to = new Dlg_check_liquid.to_guests(a.id, a.name, a.status);
                ok.add(to);
            }
//            if (version.equals("ordering")) {
...
//            }
        ...
        if (ok.isEmpty() && version.equals("resto") || ok.isEmpty() && version.equals("ordering")) {
            for (Dlg_check_liquid.to_guests a : datas) {
                Dlg_check_liquid.to_guests to = new Dlg_check_liquid.to_guests(a.id, a.name, a.status);
                ok.add(to);
