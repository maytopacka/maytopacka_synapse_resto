 ...
 * @author u2
 */
public class Dlg_logout extends javax.swing.JDialog {
    ...
    private Dlg_logout(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    private Dlg_logout(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }
    ...
    private Dlg_logout myRef;

    private void setThisRef(Dlg_logout myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_logout> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_logout create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_logout create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_logout dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_logout((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_logout((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().
                        log(Level.INFO, "instances: {0}", dialogContainer.size());
    ...
    public static void main(String args[]) {
        ...
        Dlg_logout dialog = Dlg_logout.create(new javax.swing.JFrame(), true);
...
//            validateTree();
    ...
    private void initComponents() {
        ...
        lbl_cashcount = new javax.swing.JLabel();
        ...
        jPanel2.add(ds_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 100, 31));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 460, 60));
        ...
        jPanel6.add(btn_ok, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 10, -1, 51));
        ...
        jPanel6.add(btn_clearall, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, 70, 49));
        ...
        jPanel6.add(btn_clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 10, 50, 42));
        ...
        jPanel6.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 60, 70, 20));
        ...
        jPanel6.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, 80, 20));

        jLabel10.setFont(new java.awt.Font("DejaVu Sans", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(149, 9, 12));
        jLabel10.setText("(F5)");
        jPanel6.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 80, 40, 20));
        ...
        jPanel6.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 80, 80, -1));

        jLabel15.setFont(new java.awt.Font("DejaVu Sans", 1, 14)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(41, 9, 149));
        jLabel15.setText("OK");
        jPanel6.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 60, 30, -1));
        ...
        jPanel6.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 60, 70, 20));

        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 620, 460, 100));

        lbl_cashcount.setFont(new java.awt.Font("DejaVu Sans", 1, 24)); // NOI18N
        lbl_cashcount.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbl_cashcount.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        jPanel1.add(lbl_cashcount, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 460, 51));
        ...
        pnl_numpad.add(btn_9, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 10, 140, 110));
        ...
        pnl_numpad.add(btn_6, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 130, 140, 110));
        ...
        pnl_numpad.add(btn_8, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 10, 140, 110));
        ...
        pnl_numpad.add(btn_4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 140, 110));
        ...
        pnl_numpad.add(btn_5, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 130, 140, 110));
        ...
        pnl_numpad.add(btn_7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 140, 110));
        ...
        pnl_numpad.add(btn_3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 250, 140, 110));
        ...
        pnl_numpad.add(btn_1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 140, 110));
        ...
        pnl_numpad.add(btn_2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 250, 140, 110));
        ...
        pnl_numpad.add(btn_0, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 290, 80));
        ...
        pnl_numpad.add(btn_dot, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 370, 140, 80));

        jPanel1.add(pnl_numpad, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 460, 460));
...
private void btn_dotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_dotActionPerformed
    ...
    private javax.swing.JLabel lbl_cashcount;
...
//        lbl_cashcount.setText("");
    ...
    private void do_ok1(int id, String user_name, double cash_out, double addtl_cash) {
        ...
        S11_cash_out.p_cash_count(id, cash_out, addtl_cash);
