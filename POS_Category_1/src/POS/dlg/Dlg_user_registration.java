...
//        tbl_users.setAutoResizeMode(0);
        int[] tbl_widths_accounts = {200, 100, 200};
...
//          TableWidthUtilities.
    ...
    private static class TbluserModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {"User Name", "User Level", "name"};
...
//       
    ...
    private void insert_new_user() {
        ...
        if (trigger == 0) {
            ...
            S3_insert_new_user.insert_new_user(user_name, password, user_level, name);
