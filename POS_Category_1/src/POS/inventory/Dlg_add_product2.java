...
//        public final String 
        public OutputData(String name, String description, String price, String qty, String remarks, String supplier, String vat, String assemby, List<to_product_uom> tt, String is_linient, String w_com, double amount, double cost, String img_path) {
            this.name = name;
...
//        JOptionPane.showMessageDialog(null, assembly);
        if (callback != null) {
            callback.ok(new CloseDialog(this), new OutputData(name, desc, price, qty, remarks, id, vat, assembly, tbl_employee_payroll_ALM, is_linient, w_com, amount, cost, im_path));
        }
    }
...
//        boolean h = S7_uom.check_barcode(tf_name.getText());
//        if (h == true) {
//
//            j = true;
//        } else {
