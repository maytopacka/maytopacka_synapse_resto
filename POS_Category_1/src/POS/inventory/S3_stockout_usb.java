...
import overallPOS.modules.share.utils.ObjectSerPersister;
    ...
    public static void save_ending_to_usb(List<to_add_product> datas) {
        ...
        if (action == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                to_add_product tie = new to_add_product(path, path, path, path, path, path, path, comments, comments, action, path, action,0);
