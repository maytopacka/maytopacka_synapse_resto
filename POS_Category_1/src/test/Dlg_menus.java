 ...
 * @author Dummy
 */
public class Dlg_menus extends javax.swing.JDialog {
...
private Dlg_menus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    private Dlg_menus(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }
    ...
    private Dlg_menus myRef;

    private void setThisRef(Dlg_menus myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_menus> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_menus create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_menus create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_menus dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_menus((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_menus((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_menus dialog = Dlg_menus.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        btn_tables1 = new javax.swing.JButton();
        lb_tables1 = new javax.swing.JLabel();
        btn_voider = new javax.swing.JButton();
        lb_inventory1 = new javax.swing.JLabel();
        ...
        btn_tables1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/img2/table.png"))); // NOI18N
        btn_tables1.setBorderPainted(false);
        btn_tables1.setContentAreaFilled(false);
        btn_tables1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/img2/table-MO.png"))); // NOI18N
        btn_tables1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_tables1ActionPerformed(evt);
            }
        });
        getContentPane().add(btn_tables1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 0, 80, 80));
        ...
        getContentPane().add(lb_tables1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 80, 80, -1));

        btn_voider.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/img2/void.png"))); // NOI18N
        btn_voider.setBorderPainted(false);
        btn_voider.setContentAreaFilled(false);
        btn_voider.setFocusable(false);
        btn_voider.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/img2/void-MO.png"))); // NOI18N
        btn_voider.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_voiderActionPerformed(evt);
            }
        });
        getContentPane().add(btn_voider, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 0, 90, 80));
        ...
        getContentPane().add(lb_inventory1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 90, -1));
        ...
        getContentPane().add(btn_register_users, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 70, 80));
        ...
        getContentPane().add(lb_users, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 70, -1));
...
//        do_report();
    ...
    private void btn_tables1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tables1ActionPerformed
        // TODO add your handling code here:
//        customer_table_orders();
    }//GEN-LAST:event_btn_tables1ActionPerformed

    private void btn_voiderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_voiderActionPerformed
        // TODO add your handling code here:voider()
//        voider();
...
//        do_register_users();
    ...
    private javax.swing.JButton btn_tables1;
